...
import { getDefaultDoctor, getDoctors, unselectDoctor, addUser } from "@/features/user/userSlice";
...
const Home = () => {
  ...
  console.log(user, 'user from doctors')
  ...
  return (
    <div className="sm:max-w-[580px] md:max-w-[720px] lg:max-w-[980px] lg:px-[15px] xl:max-w-[1140px] 2xl:max-w-[1390px] sm:p-4 mx-auto mt-20 lg:mt-20">
